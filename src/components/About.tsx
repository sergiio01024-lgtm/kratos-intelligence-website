      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid sm:grid-cols-1 gap-4">
              {achievements.map((achievement, index) => (
                <div key={index} className="flex items-center space-x-3">
                  ...
                  <span className="text-base font-medium text-foreground/80">{achievement}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-zinc-900 text-white rounded-2xl p-8 border border-zinc-800 shadow-2xl">
              <div className="mb-6">
              ...
              <div className="mt-8 pt-6 border-t border-zinc-800 flex justify-between items-center text-xs text-zinc-500 uppercase tracking-widest font-semibold">
